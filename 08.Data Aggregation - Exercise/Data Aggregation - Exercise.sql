...
-- 07. Deposits Filter
SELECT 
    deposit_group, SUM(deposit_amount) AS total_amount
FROM
    wizzard_deposits
WHERE
    magic_wand_creator = 'Ollivander family'
...
CREATE TABLE `salaries_more_than_30000` AS SELECT * FROM
    employees
WHERE
    salary > 30000;

DELETE FROM `salaries_more_than_30000` 
WHERE
    manager_id = 42;

UPDATE `salaries_more_than_30000` 
SET 
    salary = salary + 5000
WHERE
    department_id = 1;
